...
<div id="sidebar">
    <ul>
        ...
        <li>
            <a href="add-new-user.php"><i class="icon"></i><span>Add New User</span></a>
        </li>
        <li>
            <a href="add_new_unit.php"><i class="icon"></i><span>Add New Unit</span></a>
        </li>
        <li>
            <a href="add_new_party.php"><i class="icon"></i><span>Add New Party</span></a>
        </li>
        <li>
            <a href="add_new_company.php"><i class="icon"></i><span>Add New Company</span></a>
        </li>
        <li>
            <a href="add_new_products.php"><i class="icon"></i><span>Add New Products</span></a>
        </li>
        <li>
            <a href="purchase_master.php"><i class="icon"></i><span>purchase Master</span></a>
        </li>
        <li>
            <a href="sales_master.php"><i class="icon"></i><span>Sales Master</span></a>
        </li>
        <li>
            <a href="stock_master.php"><i class="icon"></i><span>Stock Master</span></a>
        </li>
        <li>
            <a href="view_bills.php"><i class="icon"></i><span> View Bills</span></a>
        </li>
         ...
         <li class="submenu"><a href="#"><i class="icon icon-th-list"></i> <span>Reports</span> <span
            ...
            <ul>
                ...
                <li><a href="return_product_list.php">Return Report List</a></li>
