        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid" style="background-color: white; min-height: 1000px; padding:10px;">
                <form class="form-inline" action="" name="form1" method="post">
                    ...
                    <button type="submit" name="submit1" class="btn btn-success">Show Products with Expiry Date, From These Dates</button>
                    ...
                    if(isset($_POST['submit1'])){
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php 
                                $count=0;
                            $res=mysqli_query($conn,"select * from purchase_master where (expiry_date>='$_POST[dt]' && expiry_date<='$_POST[dt2]') ");
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php 
                                $count=0;
                            $res=mysqli_query($conn,"select * from purchase_master");
                            while($row=mysqli_fetch_array($res)){
                                $count=$count+1;
                                echo "<tr>";
                                echo "<td>"; echo $count; echo "</td>";
