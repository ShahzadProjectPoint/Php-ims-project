...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <form class="form-inline" action="" name="form1" method="post">
                    ...
                    <button type="submit" name="submit1" class="btn btn-success">Show Return Products From These Dates</button>
        ...
        <?php 
        $res=mysqli_query($conn,"select * from return_products where (return_date>='$_POST[dt]' && return_date<='$_POST[dt2]') order by id desc");
        ...
        <?php 
        $res=mysqli_query($conn,"select * from return_products order by id desc");
        while($row=mysqli_fetch_array($res)){
            echo "<tr>";
        echo "<td>";  echo $row['bill_no']; echo "</td>";
        echo "<td>";  echo $row['return_date']; echo "</td>";
