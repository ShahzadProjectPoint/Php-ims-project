...
<table class="table table-bordered">
        ...
        <?php
        $res=mysqli_query($conn,"select * from billing_header where (Date>='$_POST[dt]' && Date<='$_POST[dt2]') order by id desc");
        while($row=mysqli_fetch_array($res)){
            ...
            echo "<td>"; echo get_total($row['id'],$conn); echo "</td>";
        ...
        <?php
        $res=mysqli_query($conn,"select * from billing_header order by id desc");
        while($row=mysqli_fetch_array($res)){
            echo "<tr>";
            echo "<td>"; echo $row['bill_no'];  echo "</td>";
            echo "<td>"; echo $row['username'];  echo "</td>";
...
<?php 
    function get_total($bill_id,$conn){
        $total=0;
        $res2=mysqli_query($conn,"select * from billing_details where bill_id='$bill_id'");
