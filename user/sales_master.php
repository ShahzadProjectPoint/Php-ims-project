...
<?php
    ...
    if(isset($_POST['submit1'])){
      $lastbillno=0;
      mysqli_query($conn,"insert into billing_header values(NULL,'$_POST[full_name]','$_POST[bill_type_header]','$_POST[Date]','$_POST[bill_no]','$_SESSION[user]')")  or die(mysqli_error($conn));
