...
mysqli_query($conn,"insert into return_products values(NULL,'$_SESSION[user]','$bill_no','$today_date','$product_company','$product_name','$product_unit','$packing_size','$price','$qty','$total')");
